...
jsPsych.plugins["serial-reaction-time-mouse2"] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'serial-reaction-time-mouse2',
    description: '',
    parameters: {
      target: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var stimulus = '<div class="image-stimuli">' + 
      `<span id='image1'>${trial.image1}</span>` + 
      `<span id='image2'>${trial.image2}</span>` +
      '</div>';
    ...
    if (trial.prompt !== null) {
      ...
      var resp_targets = display_element.querySelector('.image-stimuli');
      console.log(resp_targets)
  ...
  //   var stimulus = '<img src="test.jpg" alt="Noise Mask" width="500" height=375>' + '<br>' + '<img src="test.jpg" alt="Noise Mask" width="500" height=375>'
